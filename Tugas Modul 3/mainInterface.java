...
public class mainInterface {
    ...
    static void menuadmin() {
        ...
        switch (pilihan) {
            case 1:
                ...
                fakultas = inputuser.nextLine();
                System.out.print("Prodi: ");
                prodi = inputuser.nextLine();

                // Add the new user to the list
                addUser(nama, nim, fakultas, prodi);
    ...
    static void addUser(String nama, String nim, String fakultas, String prodi) {
        UserStudent newUser = new UserStudent(nama, nim, fakultas, prodi);
        arr_userStudent.add(newUser);
    }
}
